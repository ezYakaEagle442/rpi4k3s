...
wget https://github.com/raspberrypi/rpi-eeprom/blob/master/firmware/stable/pieeprom-2023-01-11.bin
...
rpi-eeprom-config pieeprom-2023-01-11.bin > bootconf.txt
...
rpi-eeprom-config --out pieeprom-2023-01-11-netboot.bin --config bootconf.txt pieeprom-2023-01-11.bin

# Update the firmware with the altered .bin file. 
sudo rpi-eeprom-update -d -f ./pieeprom-2023-01-11-netboot.bin
